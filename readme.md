...
## Compile & Run
Only Mac OS with all compnents is currently supported. However with all components installed the code will compile and run on every system (make file must be updated accordingly).
```sh
make clean
make 
./x
